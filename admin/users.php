...
<div class="container-fluid">
    <?php
        ...
        <a href="add/add_users.php" class="btn btn-dark mb-3">Add New</a>
        ...
        ?>
          <tr>
            ...
            <td><?php echo $row["cus_em"] ?></td>
            <td><?php echo $row["cus_pw"] ?></td>
            <td>
              <a href="edit/edit_users.php?id=<?php echo $row["cus_id"] ?>" ><button class='btn btn-info'>Edit</button></a>
              <a href="delete/delete_users.php?id=<?php echo $row["cus_id"] ?>"><button class='btn btn-danger'>Delete</button> </a>
            </td>
          </tr>
        <?php
        }
