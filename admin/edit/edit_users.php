...
if (isset($_POST["submit"])) {
    ...
    $sql = "UPDATE `customers` SET `cus_name`='$cus_name',`cus_ph`='$cus_ph',`cus_em`='$cus_em',`cus_pw`='$cus_pw',`cus_pw_re`='$cus_pw_re'  WHERE cus_id = $id";
    $result = mysqli_query($conn, $sql);
...
<div class="container-fluid">
    <div class="text-center mb-4">
            <h3 class='mt-3'>Edit Users Information</h3>
    </div>
